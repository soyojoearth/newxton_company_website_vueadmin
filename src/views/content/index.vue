  ...
  <div class="app-container">
    ...
    <el-card style="margin-top:10px">
      ...
      >
        ...
        <el-table-column prop="categoryName" label="类型" show-overflow-tooltip />
        ...
        <el-table-column align="right" width="80">
          <template slot-scope="scope">
            <el-col>
              <i class="el-icon-bottom" @click="handleSort(scope.$index, scope.row, 'bot')" />
              <i class="el-icon-top" @click="handleSort(scope.$index, scope.row, 'top')" />
            </el-col>
          </template>
        </el-table-column>
        ...
        <el-table-column label="推荐" align="right" width="70">
          <template slot-scope="scope">
